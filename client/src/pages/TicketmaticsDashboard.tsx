        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <Card className="bg-zinc-900/40 border-zinc-800 p-8">
              ...
              <a
                href="https://discord.com/oauth2/authorize?client_id=1408807066465865778&redirect_uri=https%3A%2F%2Fdarave.studio%2Fticketmatics%2Fdashboard&response_type=code&scope=bot%20applications.commands"
